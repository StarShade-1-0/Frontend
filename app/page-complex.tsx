...
//                 </span>
//               </h1>
//           <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto animate-slide-in-bottom stagger-2 font-medium">
//             Discover New Worlds with AI-Powered Exoplanet Detection
//           </p>
//           <p className="text-sm text-muted-foreground/70 mt-2 animate-slide-in-bottom stagger-3">
